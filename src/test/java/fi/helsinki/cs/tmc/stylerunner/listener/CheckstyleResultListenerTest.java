...
public class CheckstyleResultListenerTest {
    ...
    private AuditEvent createNewAuditEvent(final String filename, final int lineNumber, final int columnNumber, final String message, final String sourceName) {

        return new AuditEvent(sourceName, filename, new LocalizedMessage(lineNumber, columnNumber, null, null, null, null, String.class, message));
    }
